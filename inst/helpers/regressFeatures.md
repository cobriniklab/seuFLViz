...
Such regression can be performed for any arbitrary gene set. Some preset gene lists are included in `chevreulSeuratSeurat` including cell-cycle, mitochondrial, and apoptotsis related gene sets. 
