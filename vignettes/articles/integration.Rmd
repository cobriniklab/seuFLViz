...
When joint analysis of two or more single cell sequencing data is to be performed, we need to first integrate the individual datasets. In chevreulSeurat, a single function `integration_workflow` is capable of integrating multiple Seurat objects provided as a list.
...
```{r, echo=FALSE}
integrated_seu <- readRDS("~/rpkgs/chevreulSeurat/seu_integrated.rds")
```
