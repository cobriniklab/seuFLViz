...
dockerSeuratApp <- function(object = panc8, loom_path = NULL, appTitle = NULL,
    organism_type = "human", futureMb = 13000, bigwig_db = "~/.cache/chevreulSeurat/bw-files.db") {
    ...
    server <- function(input, output, session) {
        ...
        shinyhelper::observe_helpers(help_dir = system.file("helpers", package = "chevreulSeurat", lib.loc = "/dataVolume/storage/rpkgs/devel_install/"))
        options(warn = -1)
